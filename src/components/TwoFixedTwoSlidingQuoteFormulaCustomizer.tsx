...
interface TwoFixedTwoSlidingQuoteFormulaCustomizerProps {
  onClose: () => void;
...
export function TwoFixedTwoSlidingQuoteFormulaCustomizer({ onClose, onSave }: TwoFixedTwoSlidingQuoteFormulaCustomizerProps) {
  const [formula, setFormula] = useState<Formula>(() => {
    const savedFormula = localStorage.getItem('twoFixedTwoSlidingQuoteFormula');
  ...
  const handleSave = () => {
    localStorage.setItem('twoFixedTwoSlidingQuoteFormula', JSON.stringify(formula));
    onSave(formula);
    setSaved(true);
  ...
  const handleReset = () => {
    ...
    setTempInputs({});
    localStorage.removeItem('twoFixedTwoSlidingQuoteFormula');
            ...
            {showPreview && (
              <div className="mt-4 p-4 bg-gray-50 rounded-md">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <p>Ventila Fija = Alto - {formula.ventilaFijaHeight} (2 PZ)</p>
                  <p>Ventila Corrediza = Alto - {formula.ventilaCorrHeight} (2 PZ)</p>
