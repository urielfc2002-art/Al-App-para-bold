...
function WindowCalculator({ onBack, onBackToNotes, initialWidth, initialHeight, showNotesButton = false }: WindowCalculatorProps) {
  console.log('🔍 WindowCalculator - Componente renderizado. Prop showNotesButton:', showNotesButton);

  const [width, setWidth] = useSyncedState<string>('windowWidth', initialWidth || '');
  ...
  const [zocloSelection, setZocloSelection] = useSyncedState<ZocloSelection>('windowZoclo', {
    upper: 'ZOCLO 1V',
    lower: 'ZOCLO 1V'
  });
  const [formula, setFormula] = useSyncedState<Formula>('windowFormula', {
  ...
  React.useEffect(() => {
    console.log('🔍 WindowCalculator - useEffect ejecutado con:', {
      initialWidth,
      initialHeight,
      currentWidth: width,
    ...
    if (showNotesButton && initialWidth !== undefined && initialHeight !== undefined) {
      console.log('🔍 WindowCalculator - Forzando actualización desde Notas');
      if (initialWidth !== width) {
        console.log('🔍 WindowCalculator - Actualizando width de', width, 'a', initialWidth);
        setWidth(initialWidth);
      }
      if (initialHeight !== height) {
        console.log('🔍 WindowCalculator - Actualizando height de', height, 'a', initialHeight);
  ...
  return (
    <div className="min-h-screen bg-[#003366] flex flex-col items-center px-4 animate-fade-in">
      ...
      <div className="text-center my-8">
        ...
        <h2 className="text-white text-3xl font-bold mt-2">FIJO CORREDIZO</h2>
      </div>
          ...
          <>
            ...
            <div className="flex flex-col gap-4">
              ...
              <button
                onClick={() => {
                  if (onBackToNotes) {
                    console.log('🔍 WindowCalculator - Clic en botón IR A NOTAS. Llamando a onBackToNotes.');
                    onBackToNotes();
                  }
                }}
