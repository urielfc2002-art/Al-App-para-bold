...
interface SaveFormulaPiecePackageModalProps {
  onClose: () => void;
  onSave: (name: string) => void;
}

export function SaveFormulaPiecePackageModal({ onClose, onSave }: SaveFormulaPiecePackageModalProps) {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-2">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl sm:text-2xl font-bold text-[#003366]">Guardar Paquete de Fórmulas</h2>
            <button
              onClick={onClose}
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="Ej: Proyecto Fórmulas Personalizadas"
                autoFocus
              />
              {error && (
