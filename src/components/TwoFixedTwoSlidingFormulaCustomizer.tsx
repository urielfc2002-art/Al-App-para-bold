...
interface TwoFixedTwoSlidingFormulaCustomizerProps {
  onClose: () => void;
...
export function TwoFixedTwoSlidingFormulaCustomizer({ onClose, onSave }: TwoFixedTwoSlidingFormulaCustomizerProps) {
  const [formula, setFormula] = useState<Formula>(() => {
    const savedFormula = localStorage.getItem('twoFixedTwoSlidingFormula');
  ...
  const handleSave = () => {
    localStorage.setItem('twoFixedTwoSlidingFormula', JSON.stringify(formula));
    onSave(formula);
    setSaved(true);
  ...
  const handleReset = () => {
    ...
    setTempInputs({});
    localStorage.removeItem('twoFixedTwoSlidingFormula');
