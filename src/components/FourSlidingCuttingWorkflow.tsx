...
interface FourSlidingCuttingWorkflowProps {
  onBack: () => void;
  measurements: {
...
export function FourSlidingCuttingWorkflow({ onBack, measurements, zocloSelection }: FourSlidingCuttingWorkflowProps) {
  ...
  const steps: Step[] = [
    ...
    // 5. Ventila Corrediza - Cercochapa (4 pieces)
    ...
    // 6. Ventila Corrediza - Traslape (4 pieces)
