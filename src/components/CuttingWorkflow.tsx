...
export function CuttingWorkflow({ onBack, measurements, zocloSelection }: CuttingWorkflowProps) {
  ...
  return (
    <div className="min-h-screen bg-[#003366] flex flex-col items-center px-4 animate-fade-in">
      ...
      <div className="text-center my-8">
        ...
        <div className="bg-white text-[#003366] px-6 py-2 rounded-full mt-4 text-xl font-bold">
